...
class Table(BaseTable):
    ...
    def sort_index(self, sort_mode="excel", tqdm=_tqdm, pbar=None, **kwargs):
        ...
        """
        return reorder.sort_index(self, sort_mode="excel", tqdm=_tqdm, pbar=None, **kwargs)
    ...
    def pivot(self, rows, columns, functions, values_as_rows=True, tqdm=_tqdm, pbar=None):
        ...
        """
        return pivots.pivot(self, rows, columns, functions, values_as_rows=True, tqdm=_tqdm, pbar=None)
    ...
    def lookup(self, other, *criteria, all=True, tqdm=_tqdm):  # TODO: This is single core code.
        ...
        """
        return lookups.lookup(self, other, *criteria, all=True, tqdm=_tqdm)
    ...
    def imputation(self, targets, missing=None, method="carry forward", sources=None, tqdm=_tqdm):
        ...
        """
        return imputation.imputation(self, targets, missing=None, method="carry forward", sources=None, tqdm=_tqdm)
    ...
    def pivot_transpose(self, columns, keep=None, column_name="transpose", value_name="value", tqdm=_tqdm):
        ...
        """
        return pivots.pivot_transpose(self, columns, keep=None, column_name="transpose", value_name="value", tqdm=_tqdm)
