...
Tablite has multiprocessing is implemented for bypassing the GIL on all major operations. CSV import is tested with 96M fields that are imported and type-mapped to native python types in 120 secs.
...
- realratchet - Jupyter notebook integration.# Tablite
