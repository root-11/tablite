...
def test_groupby():
    ...
    t2.show()
    # +===+===+===+======+======+======+==========+========+=======+========+==============+==========+====================+====================+=========+=======+=========+
    # | # | a | b |Max(f)|Min(f)|Sum(f)|Product(f)|First(f)|Last(f)|Count(f)|CountUnique(f)|Average(f)|StandardDeviation(f)|StandardDeviation(a)|Median(f)|Mode(f)|Median(g)|
    # |row|int|int| int  | int  | int  |   int    |  int   |  int  |  int   |     int      |  float   |       float        |       float        |   int   |  int  |   int   |
    # +---+---+---+------+------+------+----------+--------+-------+--------+--------------+----------+--------------------+--------------------+---------+-------+---------+
    # |0  |  0|  0|     1|     1|     2|         1|       1|      1|       2|             1|       1.0|                 0.0|                 0.0|        1|      1|        0|
    # |1  |  1|  1|     4|     4|     8|        16|       4|      4|       2|             1|       4.0|                 0.0|                 0.0|        4|      4|        1|
    # |2  |  2|  2|     7|     7|    14|        49|       7|      7|       2|             1|       7.0|                 0.0|                 0.0|        7|      7|        8|
    # |3  |  3|  3|    10|    10|    20|       100|      10|     10|       2|             1|      10.0|                 0.0|                 0.0|       10|     10|       27|
    # |4  |  4|  4|    13|    13|    26|       169|      13|     13|       2|             1|      13.0|                 0.0|                 0.0|       13|     13|       64|
    # +===+===+===+======+======+======+==========+========+=======+========+==============+==========+====================+====================+=========+=======+=========+
