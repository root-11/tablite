...
def do_left_join():
    """Classic left join with overflow from right."""
    numbers = Table({
        "number":[1, 2, 3, 4, None],
        "colour": ["black", "blue", "white", "white", "blue"]
    })

    numbers2 = Table({
        "number": [1, 2, 3, 4, None, 1, 2, 3, 4, None, 6],
        "colour": ["black", "blue", "white", "white", "blue", "purple", "purple", "purple", "purple", "purple", "purple"]
    })

    left_join = _left_join(numbers, numbers2, left_keys=["colour"], right_keys=["colour"])
    left_join.show()
