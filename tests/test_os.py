...
def test_one_core():
    ...
    lines_per_task, _ = _text_reader_task_size(
        newlines, filesize, cpu_count, free_virtual_memory, working_overhead=0, memory_usage_ceiling=1
    )
...
def test_multi_core():
    ...
    lines_per_task, cpu_count = _text_reader_task_size(
        ...
        free_virtual_memory,
        working_overhead=0,
        memory_usage_ceiling=1,
        python_mem_w_imports=0,
    )
